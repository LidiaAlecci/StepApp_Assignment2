...
public class HourFragment  extends Fragment {
    ...
    public Cartesian createColumnChart(){
        ...
        // TO DO 1: Get the map with hours and number of steps for today
        ...
        // TO DO 2: Creating a new map that contains hours of the day from 0 to 24 and
        ...
        // TO DO 3: Replace the number of steps for each hour in graph_map
        ...
        // TO DO 4. Change the color of column chart and its border
         column.fill("#1EB980");
         column.stroke("#EB980");
        ...
        // TO DO 5: Modify column chart tooltip properties
        column.tooltip()
        ...
        // TO DO 6: Modify the UI of the cartesian
